...
const _sfc_main = {
  ...
  created() {
    this.db = common_vendor.nr.database();
  ...
  methods: {
    clear(res) {
      common_vendor.index.__f__("log", "at pages/list/search/search.nvue:172", "res: ", res);
    },
    confirm(res) {
    ...
    associativeClick(item) {
      common_vendor.index.__f__("log", "at pages/list/search/search.nvue:297", "associativeClick: ", item);
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-aaa8ea53"]]);
