...
function initRuntimeSocketService() {
  const hosts = "192.168.197.1,192.168.226.1,10.0.117.130,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_Xh6LfU";
...
const S = true, b = "mp-weixin", T = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), A = b, P = I('{"address":["127.0.0.1","192.168.197.1","192.168.226.1","10.0.117.130"],"servePort":7000,"debugPort":9000,"initialLaunchType":"local","skipFiles":["<node_internals>/**","D:/Edge download/HBuilderX.4.57.2025032507/HBuilderX/plugins/unicloud/**/*.js"]}'), C = I('[{"provider":"aliyun","spaceName":"yj-xydp","spaceId":"mp-dfb0fe14-fe9d-48ec-8569-61d44c667397","clientSecret":"QhS/+Yawj6/DNQHq1VFaWQ==","endpoint":"https://api.next.bspapp.com"}]') || [];
let O = "";
try {
  O = "__UNI__7EB004E";
} catch (e2) {
...
const { loginPage: Ss, routerNeedLogin: bs, resToLogin: ks$1, needLoginPage: Ts, notNeedLoginPage: As, loginPageInTabBar: Ps } = function({ pages: t2 = [], subPackages: n2 = [], uniIdRouter: s2 = {}, tabBar: r2 = {} } = pagesJson) {
